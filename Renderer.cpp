	...
	: mWindow(w)
{
    ...
    mObjects.push_back((new pickUp(-1.325, -0.425, 0.05)));
    mObjects.push_back((new pickUp(1.125, 0.325, 0.05)));
    mObjects.push_back((new pickUp(0.325, 0.425, 0.05)));
    mObjects.push_back((new pickUp(-1.025, 0.625, 0.05)));
    mObjects.push_back((new pickUp(0.825, -0.025, 0.05)));
